...
$siteKey = "6Le1bdQaAAAAAKAJOt2D8zqkHtwJB4xCAfhONoyM";
$secretKey = "6Le1bdQaAAAAAA3trgEt1JpB12m1eKJOcNXyoFI1";
...
function loadContact($form,$feedback='')
{
    ...
    {
        echo loadContact('multiple.php','new-feedbackB.php');
        die;
    }
